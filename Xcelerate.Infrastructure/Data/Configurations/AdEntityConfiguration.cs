...
namespace Xcelerate.Infrastructure.Data.Configurations
{
	public class AdEntityConfiguration : IEntityTypeConfiguration<Ad>
	{
		...
		private ICollection<Ad> CreateAds()
		{
			...
			{
				AdId = 11,
				CarId = 11, // Assuming CarId corresponds to the tenth car in your collection
				UserId = Guid.Parse("0C106D5A-7440-44DD-B8D3-3C1B7ACA8020"), // Assuming UserId corresponds to the tenth user in your collection
			...
			{
				AdId = 12,
				CarId = 12, // Assuming CarId corresponds to the tenth car in your collection
				UserId = Guid.Parse("B4D7DDAD-411E-4FE8-A7D9-C2638F376F1C"), // Assuming UserId corresponds to the tenth user in your collection
			...
			{
				AdId = 13,
				CarId = 13, // Assuming CarId corresponds to the tenth car in your collection
				UserId = Guid.Parse("9173EFB3-6DC6-4C27-8D1A-555107353AEA"), // Assuming UserId corresponds to the tenth user in your collection
			...
			{
				AdId = 14,
				CarId = 14, // Assuming CarId corresponds to the tenth car in your collection
				UserId = Guid.Parse("6A31BB92-7EC2-45E3-81A8-912542B314C6"), // Assuming UserId corresponds to the tenth user in your collection
			...
			{
				AdId = 15,
				CarId = 15, // Assuming CarId corresponds to the tenth car in your collection
				UserId = Guid.Parse("6A31BB92-7EC2-45E3-81A8-912542B314C6"), // Assuming UserId corresponds to the tenth user in your collection
			...
			{
				AdId = 16,
				CarId = 16, // Assuming CarId corresponds to the tenth car in your collection
				UserId = Guid.Parse("1B6F6E67-5ADF-4F78-A74E-27B02430C709"), // Assuming UserId corresponds to the tenth user in your collection
			...
			{
				AdId = 17,
				CarId = 17, // Assuming CarId corresponds to the tenth car in your collection
				UserId = Guid.Parse("6A31BB92-7EC2-45E3-81A8-912542B314C6"), // Assuming UserId corresponds to the tenth user in your collection
			...
			{
				AdId = 18,
				CarId = 18, // Assuming CarId corresponds to the tenth car in your collection
				UserId = Guid.Parse("2CC5DA14-F51C-4B51-96B3-0C296C2EE8DC"), // Assuming UserId corresponds to the tenth user in your collection
			...
			{
				AdId = 19,
				CarId = 19, // Assuming CarId corresponds to the tenth car in your collection
				UserId = Guid.Parse("B13EDF51-1FF3-46D7-BF4C-C55CAAC1A7C0"), // Assuming UserId corresponds to the tenth user in your collection
			...
			{
				AdId = 20,
				CarId = 20, // Assuming CarId corresponds to the tenth car in your collection
				UserId = Guid.Parse("6A31BB92-7EC2-45E3-81A8-912542B314C6"), // Assuming UserId corresponds to the tenth user in your collection
